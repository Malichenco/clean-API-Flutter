class ApiNetwork {
  static const String baseUrl = 'https://staging.taillz.com/api/v1/';
  ...
  static const String registration = '${baseUrl}clients/';
  ...
  static const String notifications =
      'https://staging.taillz.com/chatHub/notifications';
  ...
  static const String sendMessage =
      'https://staging.taillz.com/chatHub?id=u14M3ZAqbCo9uRG4Pu6zYw';
  static const String getNotification =
      '${baseUrl}User/Notifications?limit=20&page=';

  static const getFollowingUsers = '${baseUrl}clients/tails?mode=1';
  static const getFollowers = '${baseUrl}clients/tails?mode=02';
  ...
  static const getRepliedComments = '${baseUrl}RepliedComments/';
  static const createStory = '${baseUrl}stories';
  static const getFavourite = '${baseUrl}stories/Tailz';
  static const getAppVersion = '${baseUrl}Version/CheckAppVerison';
}
