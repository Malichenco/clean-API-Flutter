...
import 'package:Taillz/screens/Settings/write_us.dart';
import 'package:Taillz/screens/Welcome/welcome_screen.dart';
import 'package:Taillz/screens/change/change_screen.dart';
import 'package:Taillz/screens/consult/consult_screen.dart';
import 'package:Taillz/screens/enddrawer/about_us/about_us_screen.dart';
import 'package:Taillz/screens/enddrawer/blocked/blocked_users_screen.dart';
import 'package:Taillz/screens/enddrawer/privacy_policy/privacy_policy_screen.dart';
import 'package:Taillz/screens/enddrawer/terms_of_use/terms_of_use_screen.dart';
import 'package:Taillz/screens/follower/follower.dart';
import 'package:Taillz/screens/inboxscreen/user_chats_screen.dart';
import 'package:Taillz/screens/karma/karma_screen.dart';
import 'package:Taillz/screens/my_screens/my_main_screen.dart';
import 'package:Taillz/screens/thoughts/thought_screen.dart';
                ...
                child: Scaffold(
                        ...
                        children: [
                          InkWell(
                            ...
                            child: CustomUserAvatar(
                              size: 32,
                              imageUrl: state.userInfo.gender.isEmpty
                                  ...
                                  : state.userInfo.gender == 'Male'
                                      ? 'assets/images/male.png'
                                      : 'assets/images/female.png',
                              userColor: state.userInfo.gender.isEmpty
                          ...
                          InkWell(
                            ...
                            child: SvgPicture.asset(
                                'assets/images/Header_MedalPage.svg'),
                          ),
                          const SizedBox(width: 12),
                          InkWell(
                            onTap: () {
                            ...
                            child: SvgPicture.asset(
                                'assets/images/Header_Polls.svg'),
                          ),
                          const SizedBox(width: 12),
                          InkWell(
                            onTap: () async {
                          ...
                          InkWell(
                            ...
                            child: Center(
                              child: Stack(
                                ...
                                children: [
                                  SvgPicture.asset(
                                      'assets/images/Header_Notifications.svg',
                          ...
                          InkWell(
                            ...
                            child: SvgPicture.asset(
                                'assets/images/Header_Settings.svg'),
                          ),
                        ],
                      ),
                    ),
                  ...
                  body: TabBarView(
                    ...
                    children: [
                      ...
                      ConsultScreen(),
                      ChangeScreen(),
                      ThoughtsScreen(isFavourite: true),
                    ],
                  ),
                  drawer: CustomDrawer(),
                ),
                        ...
                        child: CustomUserAvatar(
                          imageUrl: state.userInfo.gender.isEmpty
                              ...
                              : state.userInfo.gender == 'Male'
                                  ? 'assets/images/male.png'
                                  : 'assets/images/female.png',
                          userColor: state.userInfo.color.isEmpty
                              ? userProvider.userInfo?.color ??
                                  'rgb(141, 153, 38)'
                              : state.userInfo.color,
                        ),
