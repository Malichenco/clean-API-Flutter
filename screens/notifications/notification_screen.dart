...
import 'package:Taillz/widgets/custom_user_avater.dart';
...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  void unreadNotifications() async {
    Uri uri = Uri.tryParse('https://staging.taillz.com/api/v1/User/ClickBell')!;
  ...
  void getNotifications() async {
    // 'https://staging.taillz.com/api/v1/User/Notifications?page=1&read=true&limit=10'
    Uri uri = Uri.tryParse(
        'https://staging.taillz.com/api/v1/User/Notifications?page=$notificationPageNumber&read=true&limit=10')!;
    WidgetProvider widgetProvider = Provider.of<WidgetProvider>(
      context,
      listen: false,
    );
