...
import 'package:Taillz/screens/enddrawer/privacy_policy/privacy_policy_screen.dart';
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              DescriptionText(text: TKeys.tailzactivity1.translate(context)),
              DescriptionText(text: TKeys.tailzactivity2.translate(context)),
              DescriptionText(text: TKeys.tailzactivity3.translate(context)),
              DescriptionText(text: TKeys.tailzactivity4.translate(context)),
              DescriptionText(text: TKeys.tailzactivity5.translate(context)),
              DescriptionText(text: TKeys.tailzactivity6.translate(context)),
              DescriptionText(text: TKeys.tailzactivity7.translate(context)),
              DescriptionText(text: TKeys.tailzactivity8.translate(context)),
              const SizedBox(
                height: 15,
              ),
