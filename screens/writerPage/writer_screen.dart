...
class WriterScreen extends StatefulWidget {
  ...
  const WriterScreen(
      {Key? key, required this.item, required this.image,this.story,required this.isFollowed})
      : super(key: key);
                ...
                children: [
                  Flexible(
                    child: ListView.builder(
                      ...
                      itemCount: widget.story == null ?localStoryProvider.userStories!.length + 1:modal.length+1,
                      itemBuilder: (context, index) {
                        ...
                        if(widget.story ==null){
                          return StoryCard(
                            ...
                            Index: index,
                            image: localStoryProvider.userStories![index].image!,
                            item: localStoryProvider.userStories![index].image!,
                            story: localStoryProvider.userStories![index],
                            route: 'thoughtScreen',
                          );
                        }else {
