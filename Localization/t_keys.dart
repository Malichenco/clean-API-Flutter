...
enum TKeys {
  ...
  discard_post,
  do_you_want,
  favorite_no_stories_message,

  PollsYouAlreadyVoted,
  PasswordRecoverySend,
  PasswordRecoveryEnterCode,
  PasswordRecoveryDidntGetCode,
  PasswordRecoveryYourEmail,
  PasswordRecoveryNewPassword,
  PasswordRecoveryConfirmNewPassword,
  PasswordRecoverySubmit,
  PasswordRecoveryPleaseFillDetails,
  PasswordRecoveryPleaseEnterEmail,
  PasswordRecoveryPasswordsNotMatch,
  Our_top,
  Writers,
  Supportive,
  UnFollow,
